<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MainProject.index" %>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 text-center">
				<div class="single-product-item">
					...
					<h3>Strawberry</h3>
					<p class="product-price"><span>Per Kg</span> 100/Kg </p>
			...
			<div class="col-lg-4 col-md-6 text-center">
				<div class="single-product-item">
					...
					<h3>Berry</h3>
					<p class="product-price"><span>Per Kg</span> 140/kg </p>
					<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
				<div class="single-product-item">
					...
					<h3>Lemon</h3>
					<p class="product-price"><span>Per Kg</span> 70/kg </p>
					<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
				</div>
			</div>
		</div>
